...
export interface ReasoningStep {
  step: number; thought: string; tool_used: string | null; tool_result: unknown | null; timestamp: string
}
export interface PlaybookStep {
  order: number; action: string; parameters: Record<string, unknown>; requires_approval: boolean
}
